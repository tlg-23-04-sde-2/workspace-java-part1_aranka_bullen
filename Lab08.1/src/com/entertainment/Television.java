...
public class Television {
    ...
    // BUSINESS METHODS (functions) - client operations can com.entertainment.Television objects do?
    public void changeChannel(String channel) {
        tuner.setChannel(channel);
    }

    public String  getCurrentChannel(){
        return tuner.getChannel();  //delegates to Tuner to get the current channel.
    }
    public void turnOn() {
    ...
    public void setBrand(String brand) {
        if (isValidBrand(brand)) {
            ...
            System.out.printf("Invalid %s. Valid brands are %s.\n", brand,Arrays.toString(VALID_BRANDS));
...
//            System.out.println("Invalid brand: " + brand + ". Valid brands are " + brands + ".");
    ...
    public void setVolume(int volume) {
        if (MIN_VOLUME <= volume && volume <= MAX_VOLUME) {
            ...
            System.out.printf( "Invalid volume: %s. Valid range is %s to %s.\n" ,volume, MIN_VOLUME, MAX_VOLUME);       // need to use \n to create new line with printf
...
//                    "Valid range is [" + MIN_VOLUME + "-" + MAX_VOLUME + "].");
    ...
    public String toString() {
        ...
        return String.format("Television: %s, Volume= %s, Display= %s, Channel= %s",
