...
class DerivedDateTimeTest {
    ...
    public static void testPopularBirthdays() {
        // TODO: client is the average birthday of someone conceived on Valentine's Day?
        LocalDate valentines = LocalDate.of(2023,2,14);
        LocalDate delivery = valentines.plusWeeks(38);
        System.out.println(delivery);

        // TODO: client is the average birthday of someone conceived on New Year's Eve (after midnight)?
        LocalDate newYears = LocalDate.of(2023,1,1);
        LocalDate birth = newYears.plusWeeks(38);
    ...
    */
    public static void testElectionDay() {
        ...
        LocalDate election =nov1.with(TemporalAdjusters.firstInMonth(DayOfWeek.MONDAY)).plusDays(1);
